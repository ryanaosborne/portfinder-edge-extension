...
3. Click **Load unpacked** and select the `portfinder-chromium-extension/` folder from this repository.
...
1. Get the latest files (e.g. `git pull`, or replace the `portfinder-chromium-extension/` folder with the new version in the same location).
